...
function analyze(githubToken, prompt, opts, callback) {
  ...
  logger.info('AI_PROMPT', 'GitHub Models API request', { model: model, promptLength: prompt.length, imageCount: images.length, provider: 'github-models' });
  ...
  var req = https.request(requestOptions, function (res) {
    ...
    res.on('end', function () {
      ...
      if (res.statusCode !== 200) {
        ...
        logger.error('AI_RESPONSE', 'GitHub Models API error', { status: res.statusCode, error: errMsg, model: model, provider: 'github-models' });
      ...
      logger.info('AI_RESPONSE', 'GitHub Models API response', {
  ...
  req.on('error', function (err) {
    ...
    logger.error('AI_RESPONSE', 'GitHub Models API request error', { error: err.message, model: model, provider: 'github-models' });
